...
async function runMigration() {
  try {
    ...
    // Using Payload's internal naming convention: pages_blocks_[blockSlug]_[fieldName]
    const tablesToCreate = [
      ...
      {
        name: 'pages_blocks_relume_team_social_links',
        sql: `CREATE TABLE IF NOT EXISTS "pages_blocks_relume_team_social_links" (
          "id" SERIAL PRIMARY KEY,
          "_order" INTEGER NOT NULL,
          "_parent_id" INTEGER NOT NULL,
          ...
          CONSTRAINT "pages_blocks_relume_team_social_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "pages_blocks_relume_team"("id") ON DELETE CASCADE
        )`
      },
      {
